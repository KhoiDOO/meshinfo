...
class MeshInfo:
    def __init__(
        ...
        check_degenerate_faces: bool = DEFAULT_CHECK_DEGENERATE_FACES,
        ...
        if self.check_degenerate_faces:
            ...
            self.num_degenerate_faces = self.num_nondegenerate_faces = CHECK_DEGENERATE_FACES_SUGGESTION_PROMPT
